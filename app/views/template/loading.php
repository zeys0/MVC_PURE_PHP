...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="3;url=<?= BASEURL ?>/Home">
    <title>Document</title>
    <link rel="stylesheet" href="<?php echo BASEURL; ?>/css/loading.css">
</head>
...
<body>
  ...
  Our Dice's Faces
-->
    <img class="loading-img" src="../public/img/loading.png" alt="">
    <div class="dice">
