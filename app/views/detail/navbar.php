...
<body>
    ...
    <header class="name-pixel bg-gradient-to-br  bg-slate-950  absolute top-0 left-0 w-full flex
    items-center z-10">
        <div class="container">
                ...
                <div class="flex items-center px-4">
                    ...
                    right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="text-slate-300 hover:bg-primary border-b
